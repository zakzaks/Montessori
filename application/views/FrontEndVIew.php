            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active"><a class="nav-link" href="<?php echo base_url() ?>FrontEnd/index">Home</a></li>
        ...
        <section class="main_slider_area">
            <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
                <ul>
                    ...
                    <!-- MAIN IMAGE -->
                        <img src="<?php echo base_url() ?>/assets/dist/img/home-slider/slider-2.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <!-- LAYER NR. 1 -->
                        <div class="slider_text_box">
                            ...
                            <div class="tp-caption tp-resizeme secand_text"
                                ...
                                style="z-index: 8;font-family:'Poppins', sans-serif;font-weight:700;color:#fff;">Oragnisasi Montessori  <br />Indonesia
                            </div>
                    ...
                    <!-- MAIN IMAGE -->
                        <img src="<?php echo base_url() ?>/assets/dist/img/home-slider/slider-4.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <!-- LAYER NR. 1 -->
                        <div class="slider_text_box">
                            <div class="tp-caption tp-resizeme secand_text"
                                data-x="['center','center','center','center','center','center']"
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="c_box_item">
                                <a href="#"><h4><i class="fa fa-user-o" aria-hidden="true"></i> About Us</h4></a>
                                <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. </p>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="c_box_item">
                                <a href="#"><h4><i class="fa fa-users" aria-hidden="true"></i> Expertise</h4></a>
                                <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. </p>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="c_box_item">
                                <a href="#"><h4><i class="fa fa-universal-access" aria-hidden="true"></i> Quality</h4></a>
                                <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d_feature_text">
                                ...
                                <p>Organisasi Montessori Indonesia (OMI is a non-profit organization, based in Jakarta, Indonesia.  
                                    It was founded on 10 January 2011, by a group of Montessori advocates, whose mission is to promote and help improve Montessori across Indonesia. 
                                    It is our hope to not just promote Montessori education in Indonesia but also to support and be a bridge to teachers, parents and the public about the child-centered educational method, Montessori.</p>
                                <a class="read_btn" href="#">Read more</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="d_feature_img">
                                <img src="<?php echo base_url() ?>assets/dist/img/feature-right.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
